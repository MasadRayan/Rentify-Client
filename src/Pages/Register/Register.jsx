    ...
    return (
        <div className='flex justify-center items-center flex-col lg:flex-row-reverse my-10 gap-10'>
            ...
            <div>
                ...
                <p className='my-3'>Register with <span className='bg-gradient-to-r from-[#ff8971] to-[#fa2a00] bg-clip-text text-transparent'>Rentify</span></p>
                <form onSubmit={handleSubmit(onSubmit)}>
                    <fieldset className="fieldset">
                        ...
                        <button className="hover:scale-105 hover:shadow-lg transition-all btn bg-gradient-to-r from-[#ff8971] to-[#fa2a00] text-white mt-4">Register</button>

                    </fieldset>
                </form>
                <p className='my-5 '>Already have an account?<Link to={'/login'} className=' bg-gradient-to-r from-[#ff8971] to-[#fa2a00] bg-clip-text text-transparent'>Login</Link></p>
